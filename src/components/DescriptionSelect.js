...
const DescriptionSelect = ({ value, onChange }) => {
  ...
  const customStyles = {
    control: (provided, state) => ({
      ...provided,
      backgroundColor: 'rgb(241 245 249)', // bg-slate-50
      borderColor: state.isFocused ? 'rgb(147 197 253)' : 'rgb(209 213 219)', // bordure bleue au focus, grise sinon 
      borderWidth: '1px',
      borderRadius: '0.375rem', // rounded-md
      boxShadow: state.isFocused ? '0 0 0 2px rgb(147 197 253)' : provided.boxShadow, // anneau bleu au focus
      '&:hover': {
        borderColor: state.isFocused ? 'rgb(147 197 253)' : 'rgb(156 163 175)', // bordure bleue ou grise au hover
      },
      padding: '0.18rem',
    }),
